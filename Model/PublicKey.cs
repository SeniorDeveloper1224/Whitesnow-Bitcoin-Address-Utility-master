...
namespace Casascius.Bitcoin {
    ...
    public class PublicKey : AddressBase {
        ...
        public PublicKey(Org.BouncyCastle.Math.EC.ECPoint point) {
        ...
        protected Org.BouncyCastle.Math.EC.ECPoint point = null;
        ...
        public static Org.BouncyCastle.Math.EC.ECPoint GetUncompressed(Org.BouncyCastle.Math.EC.ECPoint point) {
            var ps = Org.BouncyCastle.Asn1.Sec.SecNamedCurves.GetByName("secp256k1");
            return ps.Curve.CreatePoint(point.X.ToBigInteger(), point.Y.ToBigInteger(), false);
        }

        public static Org.BouncyCastle.Math.EC.ECPoint GetCompressed(Org.BouncyCastle.Math.EC.ECPoint point) {
            var ps = Org.BouncyCastle.Asn1.Sec.SecNamedCurves.GetByName("secp256k1");
