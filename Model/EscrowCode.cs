...
namespace Casascius.Bitcoin {
    public class EscrowCodeSet {
        ...
        public EscrowCodeSet() {
            ...
            Org.BouncyCastle.Math.EC.ECPoint Gx = kx.GetECPoint();
            byte[] bytesGx = Gx.GetEncoded();
            Org.BouncyCastle.Math.EC.ECPoint Gy = ky.GetECPoint();
            byte[] bytesGy = Gy.GetEncoded();
            Org.BouncyCastle.Math.EC.ECPoint Gxy = Gx.Multiply(yi);
        ...
        public EscrowCodeSet(string escrowInvitationCode, bool doCompressed=false, byte networkByte = 0) {
            ...
            Org.BouncyCastle.Math.EC.ECPoint Gxyz = pk.GetECPoint().Multiply(new BigInteger(1, privpart)).Multiply(new BigInteger(1, z));
        ...
        public EscrowCodeSet(string code1, string code2) {
            ...
            // get bitcoin address
            PublicKey pk = new PublicKey(pubpart);
            Org.BouncyCastle.Math.EC.ECPoint Gxyz = pk.GetECPoint().Multiply(new BigInteger(1, privpart)).Multiply(new BigInteger(1, privpartz));
