...
namespace Casascius.Bitcoin {
    public class Util {
        ...
        public static string PrivHexToPubHex(string PrivHex, Org.BouncyCastle.Math.EC.ECPoint point) {
        ...
        public static Org.BouncyCastle.Math.EC.ECPoint PrivHexToPubKey(string PrivHex) {
            byte[] hex = ValidateAndGetHexPrivateKey(0x00, PrivHex, 33);
            if (hex == null) throw new ApplicationException("Invalid private hex key");
        ...
        public static Org.BouncyCastle.Math.EC.ECPoint PrivKeyToPubKey(byte[] PrivKey) {
        ...
        public static byte[] PubKeyToByteArray(Org.BouncyCastle.Math.EC.ECPoint point) {
